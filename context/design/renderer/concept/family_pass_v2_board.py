...
OUT=ROOT/'renderer/concept/family-pass-v2-out'
...
rows=[
 ...
 ('02 / SETTINGS — MORE COLOR IN EDITORS',[
  ...
  ('OFFSET','D2 PROPOSAL',OUT/'settings-D2-offset.png'),('ZONE','D2 PROPOSAL',OUT/'settings-D2-zone.png'),
  ('BRIGHTNESS','D2 PROPOSAL',OUT/'settings-D2-brightness.png'),('TIMEOUT','D2 PROPOSAL',OUT/'settings-D2-timeout.png')]),
 ('03 / DEVICE — REPLAY ROUTE',[
  ('DEVICE TOP','D2 PROPOSAL',OUT/'settings-D2-device-top.png'),('DEVICE END','D2 PROPOSAL',OUT/'settings-D2-device-end.png'),
  ('REPLAY CHOICE','D2 PROPOSAL',OUT/'settings-D2-replay-choice.png'),('FAILURE DEMO','D2 PROPOSAL',OUT/'settings-D2-replay-failure.png'),
 ...
 ('04 / ALWAYS ON — BATTERY AND UTC',[
  ('LOCAL 13:07','H2b PROPOSAL',OUT/'aod-H2b-local-1307.png'),('LOCAL 13:08','H2b PROPOSAL',OUT/'aod-H2b-local-1308.png'),
  ('NO ZONE / UTC','H2b PROPOSAL',OUT/'aod-H2b-nozone.png'),('STOPPED','H2b PROPOSAL',OUT/'aod-H2b-stopped.png'),
  ('NO DATA','H2b PROPOSAL',OUT/'aod-H2b-nodata.png'),('LOW BATTERY','H2b PROPOSAL',OUT/'aod-H2b-battery-low.png')])]
W=2*M+N*S+(N-1)*G;H=HEAD+len(rows)*(ROW+S+CAP)+(len(rows)-1)*BETWEEN+42
board=Image.new('RGB',(W,H),(18,20,23));d=ImageDraw.Draw(board)
d.text((M,28),'OCTOWHERE / FAMILY PASS V2',font=big,fill=(221,225,231))
...
board.save(OUT/'family-pass-v2-board.png',optimize=True)
...
comparison('settings-D2-comparison.png','SETTINGS / D1 → D2',[
    ('OFFSET D1',V1/'settings-D1-manual-time.png'),('OFFSET D2',OUT/'settings-D2-offset.png'),
    ('ZONE D1',V1/'settings-D1-zone.png'),('ZONE D2',OUT/'settings-D2-zone.png'),
    ('BRIGHTNESS D1',V1/'settings-D1-brightness.png'),('BRIGHTNESS D2',OUT/'settings-D2-brightness.png')])
comparison('aod-H2b-comparison.png','AOD / H2 → H2b',[
    ('LOCAL H2',ROOT/'renderer/concept/glitch-package/aod-H2-1307.png'),('LOCAL H2b',OUT/'aod-H2b-local-1307.png'),
    ('NO ZONE H2 D1',V1/'aod-H2-nozone.png'),('NO ZONE H2b',OUT/'aod-H2b-nozone.png')])
