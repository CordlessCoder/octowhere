...
impl Reveal {
    ...
    /// block.
    fn of(progress: u8, n: usize) -> Self {
...
fn draw_revealed<D: CoverageTarget<Color = Color>>(
...
fn revealed_bounds(style: &FontdueRenderer<'static, Color>, text: &str, pen: Point) -> Rectangle {
